...
#Read in data
data <- read.csv("data/standardSuperSimProportionSummary_upToRound6.csv", stringsAsFactors = FALSE)
actualProp <- read.csv("data/actualSuperShotProportion_upToRound6.csv", stringsAsFactors = FALSE)
